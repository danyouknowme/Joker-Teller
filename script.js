...
const buttonScript = document.getElementById("button-script");
const jokeScript = document.getElementById("joke-script");
...
const script = (joke) => {
  jokeScript.hidden = true;
  jokeScript.innerHTML = joke;
}
...
const tellMe = (joke) => {
  ...
  VoiceRSS.speech({
    // Free API Key
    key: "f8617b6e673746528af786134e250798",
    src: joke,
    hl: 'en-us',
    v: 'Linda',
    r: 0, 
...
buttonScript.addEventListener("click", () => jokeScript.hidden=false);